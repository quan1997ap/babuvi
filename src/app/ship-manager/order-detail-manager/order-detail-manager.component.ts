...
@Component({
    selector: 'app-order-detail-manager',
    templateUrl: './order-detail-manager.component.html',
    styleUrls: ['./order-detail-manager.component.scss']
})
export class OrderDetailManagerComponent implements OnInit {
    ...
    orderBuy() {
        //this.router.navigate(['order/order-buy?', {orderId: this.orderId} ]);
        //this.router.navigate([this.router.url + '\0'], { queryParams: { 'orderId': this.orderId} });
        //this.router.navigate(['order/order-buy/'], { queryParams: { orderid: this.orderId } });
        const url = this.router.serializeUrl(this.router.createUrlTree(['order/order-buy/'], { queryParams: {orderid: this.orderId } }));
