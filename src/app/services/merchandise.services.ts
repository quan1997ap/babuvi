...
export class MerchandiseServices extends ApiService {
  ...
  getMerchandiseViewModel(orderCode: string, perPage, page) {
    const param =
      "?orderCode=" + orderCode + "&perPage=" + perPage + "&page=" + page;
    return this.get(
      this.apiBaseController +
        ApiApplication.merchandise.getMerchandiseViewModel +
        param
    );
  }
  ...
  getStatus() {
    return this.get(
      ApiApplication.system.controller +
        "/" +
        ApiApplication.system.getOrderStatus
    );
  }
  ...
  deleteMerchandise(merchandiseIds: number[]) {
    ...
    return this.delete(
      this.apiBaseController + ApiApplication.merchandise.deleteMerchandise,
      body
    );
  }
  ...
  getMerchandiseHistory(merchandiseId: number, perPage, page) {
    ...
    return this.get(
      this.apiBaseController +
        ApiApplication.merchandise.getMerchandiseHistory +
        param
    );
  }
  ...
  completeMerchandise(orderCode) {
    return this.put(
      ApiApplication.order.controller +
        "/" +
        ApiApplication.order.completeAddMerchandise +
        orderCode
    );
  }
  ...
  countSumMerchandiseInWarehouse(userId: number) {
    return this.get(
      this.apiBaseController +
        ApiApplication.merchandise.countSumMerchandiseInWarehouse +
        "?userId=" +
        userId
    );
  }
  ...
  getMerchandiseInWarehouseManager(userCode, page, perPage) {
    const param =
      "?userCode=" + userCode + "&perPage=" + perPage + "&page=" + page;
    return this.get(
      this.apiBaseController +
        ApiApplication.merchandise.getMerchandiseInWarehouseManager +
        param
    );
  }
  ...
  getMerchandiseInWarehouse(page, perPage) {
    ...
    return this.get(
      this.apiBaseController +
        ApiApplication.merchandise.getMerchandiseInWarehouse +
        param
    );
  }
  ...
  getLsMerchandiseByMWId(mwIds) {
    ...
    return this.post(
      this.apiBaseController +
        ApiApplication.merchandise.getLsMerchandiseByMWId,
      body
    );
  }
  ...
  addDeliveryRequest(body: DeliveryRequest) {
    return this.post(
      this.apiBaseController + ApiApplication.merchandise.addDeliveryRequest,
      body
    );
  }
  ...
  getDeliveryRequestByCode(code) {
    ...
    return this.get(
      this.apiBaseController +
        ApiApplication.merchandise.getDeliveryRequestByCode +
        param
    );
  }
  ...
  createPackage(body) {
    return this.post(
      this.apiBaseController + ApiApplication.merchandise.createPackage,
      body
    );
  }
  ...
  sendDelivery(body) {
    return this.post(
      this.apiBaseController + ApiApplication.merchandise.sendDelivery,
      body
    );
  }
  ...
  cancelDelivery(body) {
    return this.post(
      this.apiBaseController + ApiApplication.merchandise.cancelDelivery,
      body
    );
  }
  ...
  getDeliveryAddressDefault() {
    return this.get(
      this.apiBaseController +
        ApiApplication.merchandise.getDeliveryAddressDefault
    );
  }
  ...
  getMerchandiseByCode(merchandiseCode) {
    ...
    return this.get(
      this.apiBaseController +
        ApiApplication.merchandise.getMerchandiseByCode +
        param
    );
  }
  ...
  getLsMerchandiseInWhByOrderId(orderId) {
    ...
    return this.get(
      this.apiBaseController +
        ApiApplication.merchandise.getLsMerchandiseInWhByOrderId +
        param
    );
  }
  ...
  getDeliveryRequestType() {
    return this.get(
      ApiApplication.system.controller +
        "/" +
        ApiApplication.system.getDeliveryRequestType
    );
  }
  getDeliveryRequestStatus() {
    return this.get(
      ApiApplication.system.controller + "/getDeliveryRequestStatus"
    );
  }
  searchListDeliveryRequest(page: any, perPage: any, datasearch: any) {
    return this.post(
      this.apiBaseController +
        `searchListDeliveryRequest/?page=${page}&perPage=${perPage}`,
      datasearch
    );
  }
  searchListDeliveryRequestManager(page: any, perPage: any, datasearch: any) {
    return this.post(
      this.apiBaseController +
        `searchListDeliveryRequestManager/?page=${page}&perPage=${perPage}`,
      datasearch
    );
  }
  deleteLsDeliveryRequest(deleteIds: any) {
    return this.put(
      this.apiBaseController + "cancelLsDeliveryRequest/",
      deleteIds
    );
  }
  ...
  searchMerchandise(page: number, perPage: number, data) {
    return this.post(
      this.apiBaseController +
        `searchMerchandise?perPage=${perPage}&page=${page}`,
      data
    );
  }
  ...
  searchMerchandiseManager(page: number, perPage: number, data) {
    return this.post(
      this.apiBaseController +
        `searchMerchandiseManager?perPage=${perPage}&page=${page}`,
      data
    );
  }
