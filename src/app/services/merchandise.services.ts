...
export class MerchandiseServices extends ApiService {
    ...
    editMerchandiseManager(data: Merchandise) {
        return this.post(this.apiBaseController + ApiApplication.merchandise.editMerchandiseManager, data);
    }
    ...
    getLsDeliveryRequestNewByUserId(id) {
        const param = '?userId=' + id;
        return this.get(this.apiBaseController + ApiApplication.merchandise.getLsDeliveryRequestNewByUserId + param);
    }
    ...
    mergeDeliveryRequest(body: any) {
        return this.post(this.apiBaseController + ApiApplication.merchandise.mergeDeliveryRequest, body);
    }
    ...
    cancelDeliveryRequest(deliveryRequestId:any){
        return this.put(this.apiBaseController + ApiApplication.merchandise.cancelDeliveryRequestStaff + `?deliveryRequestId=${deliveryRequestId}`)
    }
    ...
    checkMerchandiseByCode(merchandiseCode) {
        const param = '?merchandiseCode=' + merchandiseCode;
        return this.get(this.apiBaseController + ApiApplication.merchandise.checkMerchandiseByCode + param);
    }
    ...
    getLsAttachFileByMerchandiseCode(merchandiseCode) {
        const param = '?merchandiseCode=' + merchandiseCode;
        return this.get(this.apiBaseController + ApiApplication.merchandise.getLsAttachFileByMerchandiseCode + param);
    }
    ...
    getMerchandiseByCodeOrPosition(codeOrPosition) {
        return this.get(
          ApiApplication.merchandise.controller + `/getMerchandiseByCodeOrPosition?codeOrPosition=${codeOrPosition}`
        );
      }

    changeShelfPositionMerchandise(merchandiseInfor){
        return this.put(
          ApiApplication.merchandise.controller + `/changeShelfPositionMerchandise`,
          merchandiseInfor
        );
      }
}
