...
export class TaskServices extends ApiService {
    ...
    addNewDefaultTask(){
        return this.post(this.apiBaseController + `addNewDefaultTask`)
    }
    ...
    getTaskTypeManual(){
        return this.get(ApiApplication.system.controller + "/getTaskTypeManual")
    }
    getTaskStatus(){
    ...
    findRefCode(refCode:any){
        return this.get(this.apiBaseController + `findRefCode?refCode=${refCode}`)
    }
}