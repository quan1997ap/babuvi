...
export class SystemService extends ApiService {
    ...
    getTypeCustomer() {
        return this.get(this.apiBaseController + ApiApplication.system.getWalletTransactionsTypeCustomer);
    }
    ...
    GetReasionCustomer(){
        return this.get(this.apiBaseController + ApiApplication.system.getReasionCustomer)
    }
    ...
    getShippingType() {
        ...
        return this.get( ApiApplication.service.controller + '/getLsServiceGroupOrderConsignment').pipe(map((res: any) => {
            if (res.message === 'successful') {
                // success -->
                return res.result.data;
            } else {
    ...
    getDeliveryRequestType() {
        return this.get(this.apiBaseController + ApiApplication.system.getDeliveryRequestType);
    }

    getPaymentShipType() {
        return this.get(this.apiBaseController + ApiApplication.system.getPaymentShipType);
    }
