...
export class CartServices extends ApiService {
  ...
  addPrFindByLinkToCart(data){
    const url =  ApiApplication.Extension.controller + '/ext/addToCart';
    return this.post(url, data)
  }

  getProductDataByUrl(productUrl){
    const url =  ApiApplication.cart.controller + '/GetProductDataByUrl';
    return this.post(url, {"stringData": productUrl });
}
}
