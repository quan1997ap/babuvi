...
export class OrderService extends ApiService {
    ...
    editDepositOrder(orderBuy: OrderBuy) {
        return this.put(this.apiBaseController + ApiApplication.order.editDepositOrder, orderBuy);
    }

    editDepositOrderAfterBuy(orderBuy: OrderBuy) {
        return this.put(this.apiBaseController + ApiApplication.order.editDepositOrderAfterBuy, orderBuy);
    }
