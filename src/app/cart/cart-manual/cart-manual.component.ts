...
export class CartManualComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //console.log(this.getMaxNumber(this.data_mock))
  }
  ...
  themSP() {
    this.data_mock.push(this.getMaxNumber(this.data_mock) + 1); console.log(this.data_mock)
  }
  ...
  formSubmit(form) {
    ...
    this.ConfirmationService.confirm({
      ...
      accept: () => {
        ...
        console.log({ Items: listItemOrder });
  ...
  AddAttachFile(panel, rowValue) {
    ...
    this.fileManagerServices.uploadImg(formdat).toPromise().then(data => {console.log(data)
