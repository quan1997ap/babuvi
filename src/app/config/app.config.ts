...
export const ApiBaseUrl = "https://backendtest.babuvi.com/api/";
//export const ApiBaseUrl = "http://localhost:5000/api/";
//export const ApiBaseUrl = "http://localhost:62433/api/";
...
//Type: 16
//Trạng thái cơ bản dùng chung cho nhiều bảng
export const StatusBasic = {
 ...
 //Type: 75
 export const PaymentShipType = {
     WalletPay: "1",
     SelfPay: "2",
 }

 //Type: 39
 export const AppDeliveryRequestType = {
    ChuyenPhatNhanh: "1",
    ChuyenPhatTichKiem: "2",
    GiaoNoiThanh: "3",
    NhanTaiKho: "4",
    GiaoXeKhach: "5",
    DropShip: "6",
...
export const ApiApplication = {
    ...
    shipManager: {
        ...
        cancelOrderConsignment: 'cancelOrderConsignment',
        searchOrderManager: 'searchOrderManager',
        searchOrderStaff: 'searchOrderStaff',
        searchOrdersAffiliate: 'searchOrdersAffiliate',
    ...
    fileManager: {
        ...
        refreshImageByDeliveryCode: "refreshImageByDeliveryCode",
    },
    compplain: {
    ...
    merchandise: {
        ...
        editMerchandiseManager: 'editMerchandiseManager/',
    ...
    order: {
        ...
        editDepositOrder: 'editDepositOrder',
        editDepositOrderAfterBuy: 'editDepositOrderAfterBuy',
    ...
    user: {
        ...
        regAffiliateUser: 'regAffiliateUser/',
