(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~merchandise-merchandise-module~warehouseimp-warehouse-imp-module"],{
...
/***/ "./src/app/services/merchandise.services.ts":
/*!**************************************************!*\
  !*** ./src/app/services/merchandise.services.ts ***!
  \**************************************************/
/*! exports provided: MerchandiseServices */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MerchandiseServices", function() { return MerchandiseServices; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var MerchandiseServices = /** @class */ (function (_super) {
    __extends(MerchandiseServices, _super);
    function MerchandiseServices(http, _router) {
        return _super.call(this, app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.controller, http, _router) || this;
    }
    MerchandiseServices.prototype.getMerchandiseViewModel = function (orderCode, perPage, page) {
        var param = "?orderCode=" + orderCode + "&perPage=" + perPage + "&page=" + page;
        return this.get(this.apiBaseController +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.getMerchandiseViewModel +
            param);
    };
    MerchandiseServices.prototype.getStatus = function () {
        return this.get(app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].system.controller +
            "/" +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].system.getOrderStatus);
    };
    MerchandiseServices.prototype.saveMerchandise = function (data) {
        return this.post(this.apiBaseController + app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.addMerchandise, data);
    };
    MerchandiseServices.prototype.addMerchandise = function (data) {
        return this.post(this.apiBaseController + app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.addMerchandise, data);
    };
    MerchandiseServices.prototype.deleteMerchandise = function (merchandiseIds) {
        var body = {
            lsId: merchandiseIds,
        };
        return this.delete(this.apiBaseController + app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.deleteMerchandise, body);
    };
    MerchandiseServices.prototype.getMerchandiseHistory = function (merchandiseId, perPage, page) {
        var param = "?merchandiseId=" +
            merchandiseId +
            "&perPage=" +
            perPage +
            "&page=" +
            page;
        return this.get(this.apiBaseController +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.getMerchandiseHistory +
            param);
    };
    MerchandiseServices.prototype.completeMerchandise = function (orderCode) {
        return this.put(app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].order.controller +
            "/" +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].order.completeAddMerchandise +
            orderCode);
    };
    MerchandiseServices.prototype.countSumMerchandiseInWarehouse = function (userId) {
        return this.get(this.apiBaseController +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.countSumMerchandiseInWarehouse +
            "?userId=" +
            userId);
    };
    MerchandiseServices.prototype.getMerchandiseInWarehouseManager = function (userCode, page, perPage) {
        var param = "?userCode=" + userCode + "&perPage=" + perPage + "&page=" + page;
        return this.get(this.apiBaseController +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.getMerchandiseInWarehouseManager +
            param);
    };
    MerchandiseServices.prototype.getMerchandiseInWarehouse = function (page, perPage) {
        var param = "?perPage=" + perPage + "&page=" + page;
        return this.get(this.apiBaseController +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.getMerchandiseInWarehouse +
            param);
    };
    MerchandiseServices.prototype.getLsMerchandiseByMWId = function (mwIds) {
        var body = {
            lsId: mwIds,
        };
        return this.post(this.apiBaseController +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.getLsMerchandiseByMWId, body);
    };
    MerchandiseServices.prototype.addDeliveryRequest = function (body) {
        return this.post(this.apiBaseController + app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.addDeliveryRequest, body);
    };
    MerchandiseServices.prototype.getDeliveryRequestByCode = function (code) {
        var param = "?deliveryRequestCode=" + code;
        return this.get(this.apiBaseController +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.getDeliveryRequestByCode +
            param);
    };
    MerchandiseServices.prototype.createPackage = function (body) {
        return this.post(this.apiBaseController + app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.createPackage, body);
    };
    MerchandiseServices.prototype.sendDelivery = function (body) {
        return this.post(this.apiBaseController + app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.sendDelivery, body);
    };
    MerchandiseServices.prototype.cancelDelivery = function (body) {
        return this.post(this.apiBaseController + app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.cancelDelivery, body);
    };
    MerchandiseServices.prototype.getDeliveryAddressDefault = function () {
        return this.get(this.apiBaseController +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.getDeliveryAddressDefault);
    };
    MerchandiseServices.prototype.getMerchandiseByCode = function (merchandiseCode) {
        var param = "?merchandiseCode=" + merchandiseCode;
        return this.get(this.apiBaseController +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.getMerchandiseByCode +
            param);
    };
    MerchandiseServices.prototype.getLsMerchandiseInWhByOrderId = function (orderId) {
        var param = "?orderId=" + orderId;
        return this.get(this.apiBaseController +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.getLsMerchandiseInWhByOrderId +
            param);
    };
    MerchandiseServices.prototype.getDeliveryRequestType = function () {
        return this.get(app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].system.controller +
            "/" +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].system.getDeliveryRequestType);
    };
    MerchandiseServices.prototype.getDeliveryRequestStatus = function () {
        return this.get(app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].system.controller + "/getDeliveryRequestStatus");
    };
    MerchandiseServices.prototype.searchListDeliveryRequest = function (page, perPage, datasearch) {
        return this.post(this.apiBaseController +
            ("searchListDeliveryRequest/?page=" + page + "&perPage=" + perPage), datasearch);
    };
    MerchandiseServices.prototype.searchListDeliveryRequestManager = function (page, perPage, datasearch) {
        return this.post(this.apiBaseController +
            ("searchListDeliveryRequestManager/?page=" + page + "&perPage=" + perPage), datasearch);
    };
    MerchandiseServices.prototype.deleteLsDeliveryRequest = function (deleteIds) {
        return this.put(this.apiBaseController + "cancelLsDeliveryRequest/", deleteIds);
    };
    MerchandiseServices.prototype.searchMerchandise = function (page, perPage, data) {
        return this.post(this.apiBaseController +
            ("searchMerchandise?perPage=" + perPage + "&page=" + page), data);
    };
    MerchandiseServices.prototype.searchMerchandiseManager = function (page, perPage, data) {
        return this.post(this.apiBaseController +
            ("searchMerchandiseManager?perPage=" + perPage + "&page=" + page), data);
    };
    //quandev
    MerchandiseServices.prototype.startHandleDeliveryRequest = function (lsId) {
        return this.post(app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.controller +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.startHandleDeliveryRequest, { lsId: lsId });
    };
    MerchandiseServices.prototype.finishHandleDeliveryRequest = function (lsId) {
        return this.post(app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.controller +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.finishHandleDeliveryRequest, { lsId: lsId });
    };
    MerchandiseServices.prototype.cancelHandleDeliveryRequest = function (lsId) {
        return this.post(app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.controller +
            app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.cancelHandleDeliveryRequest, { lsId: lsId });
    };
    MerchandiseServices.prototype.changeStatusDeliveryRequestDetail = function (requestId) {
        return this.post(app_config_app_config__WEBPACK_IMPORTED_MODULE_3__["ApiApplication"].merchandise.controller +
            ("/changeStatusDeliveryRequestDetail?deliveryRequestDetailId=" + requestId));
    };
    MerchandiseServices = __decorate([
...
//# sourceMappingURL=default~merchandise-merchandise-module~warehouseimp-warehouse-imp-module.js.map