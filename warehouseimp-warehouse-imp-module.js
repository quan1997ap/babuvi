...
var AddWarehouseImpComponent = /** @class */ (function () {
    ...
    */
    ...
    AddWarehouseImpComponent.prototype.checkNextControlNNetWeight = function ($event, netWeight, type) {
        var _this = this;
        if (this.loading == false) {
